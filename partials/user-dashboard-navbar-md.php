<div class="col-sm-3 sidenav hidden-xs">
    <h2>MotoGuard Vehicle Insurance-Dashboard</h2>
    <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="../views/view-claim-status.php">Claim Status Management</a></li>
        <li><a href="../views/customer-management.php">Customer Management</a></li>
